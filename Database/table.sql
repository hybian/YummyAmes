...
/*Item 7: The customer account table*/
create table c_account(
c_id char (20) not null,
c_name char (20) not null,
c_password char (30) not null,
c_email char (30),
c_phone char (20),
c_address char (50),
primary key(c_id));

/*Item 8: The manager account table*/
...
INSERT INTO m_account(m_id, m_name, m_password) VALUES ('test5','Ao Liu','liuao2017');
INSERT INTO m_account(m_id, m_name, m_password) VALUES ('test6','Ao Liu','liuao2017');
INSERT INTO m_account(m_id, m_name, m_password) VALUES ('test7','Ao Liu','123456');
INSERT INTO m_account(m_id, m_name, m_password) VALUES ('test8','Ao Liu','123456');
INSERT INTO m_account(m_id, m_name, m_password) VALUES ('aliu','Ao Liu','liuao2017');

select * from m_account where(m_name='Ao Liu' and m_password='liuao2017');
