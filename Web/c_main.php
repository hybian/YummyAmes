...
<body class=" theme-blue">
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          ...
          <a class="" href="Administrator"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> YummyAmes Customer</span></a></div>

        <div class="navbar-collapse collapse" style="height: 1px;">
          <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-user padding-right-small" style="position:relative;top: 3px;"></span> <?php echo $_SESSION[c_name];?>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a href="login1.php" target="_self" name="logout" id="logout">logout</a></li>
              </ul>
            </li>
          </ul>
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
		...
		<li ><a href="c_order.php" target="_self"><span class="fa fa-caret-right"></span>My order</a></li>
		<li ><a href="cart.php" target="_self"><span class="fa fa-caret-right"></span>check cart</a></li>	
    </ul></li>
        ...
        <li><ul class="accounts-menu nav nav-list collapse">
            ...
            <li><a href="c_change.php"><span class="fa fa-caret-right"></span>change information</a></li>
    </ul></li>
