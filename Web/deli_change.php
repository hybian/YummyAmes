...
<title>Deliverman information change</title>
<!--STYLESHEETS-->
...
<?php if($_POST["submit"]){
	...
	$sql1="select * from Deliver where d_username = '".$_SESSION[d_name]."' ";  
	...
	if($uname==""){
		...
		$sql="UPDATE Deliver set d_name='".$uname."', d_email = '".$uemail."', d_phone='".$uphone."' where d_username='".$_SESSION[d_name]."' ";
...
<?php
	...
	echo "Deliverman information change successfully! After 3 seconds go to Deliverman main page";
		header("Refresh:3;url=delivermain.php");
	}
?>

<p><a href="delivermain.php" target="_self">cancel</a></p>
</body>
</html>