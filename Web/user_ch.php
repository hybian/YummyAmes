...
<body class=" theme-blue">
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
        ...
        <li><a href="#" data-target=".accounts-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-briefcase"></i> Account <span class="label label-info"></span></a></li>
...
<?php 
		$usid=$_GET['id'];
		$sql="select * from Customer where c_name='".$usid."' ";
  ...
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form id="tab">
        ...
        <input type="text" value="<?php echo $rows[1]?>" class="form-control">
        </div>
        <div class="form-group">
        <label>Username</label>
        <input type="text" value="<?php echo $rows[5]?>" class="form-control">
        </div>
        <div class="form-group">
        <label>Phone</label>
        <input type="text" value="<?php echo $rows[3]?>" class="form-control">
        </div>
        <div class="form-group">
        <label>Email</label>
        <input type="text" value="<?php echo $rows[4]?>" class="form-control">
        </div>

        <div class="form-group">
          <label>Address</label>
          <input type="text" value="<?php echo $rows[2]?>" style="width:300px; height:60px" class="form-control">
        </div>
