...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>Deliverman main page</title>
...
<body class=" theme-blue">
          ...
          <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-user padding-right-small" style="position:relative;top: 3px;"></span> <?php echo $_SESSION[d_name];?>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a href="d_login.php" target="_self" name="logout" id="logout">logout</a></li>
              </ul>
            </li>
          </ul>
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            <li><a href="delivermain.php"><span class="fa fa-caret-right"></span> Main</a></li>
		<li ><a href="o_list.php" target="_self"><span class="fa fa-caret-right"></span>Order list</a></li>
		<li ><a href="ac_order.php" target="_self"><span class="fa fa-caret-right"></span>Accepted list</a></li>
    </ul></li>
        ...
        <li><ul class="accounts-menu nav nav-list collapse">
            ...
            <li><a href="deli_change.php"><span class="fa fa-caret-right"></span>change information</a></li>
    </ul></li>
